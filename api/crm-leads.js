...
async function handleLeadSquared(req, res, me) {
  ...
  const NOT_ATTEMPTED_MODES = ['not_attempted_opportunities', 'attempted_not_closed_opportunities', 'disposition_status_lookup', 'attempt_count_lookup', 'opp_single_debug']
