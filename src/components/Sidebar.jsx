...
const NAV = [
  {
    ...
    items: [
      ...
      { to: '/dashboard/roas', icon: <ChartIcon />, label: 'ROAS 2025', end: false },
    ]
  },
  {
    label: 'Coming Soon',
    items: [
      { to: '#', icon: <FunnelIcon />, label: 'Lead Quality', soon: true },
        ...
        {NAV.map(group => (
          <div key={group.label} className={styles.group}>
            ...
            {group.items.map(item =>
              item.soon ? (
                <div key={item.label} className={styles.navSoon}>
