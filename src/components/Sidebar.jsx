...
// Moved to ../lib/pageList.js so App.jsx's route-guard fallback can import
// just this plain data array without pulling in the whole Sidebar component
// tree (icons, styles, SnapshotTool, PresentationTool, ...) into its own
// eagerly-loaded bundle. Re-exported here (this file still uses it below) so
// every existing `import { PAGE_LIST } from '../components/Sidebar'` keeps
// working unchanged.
export { PAGE_LIST }
