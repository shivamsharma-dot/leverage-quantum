...
export const REPORT_VERSIONS = [
  {
    ...
    recommended: false,
    what: [
      'Message 1 (Marketing Efficiency) — Marketing Spend, Total Leads, Total QLs (with its SR/AC vertical split), CPL, CPQL and Lead to QL % as a native table, one row each for Overall, Paid, Organic (folds in the small "Others" bucket) and Referral. Organic/Referral show Spend/CPL/CPQL as a dash, never a stray near-zero figure — neither runs real media spend. Lead to QL % is Quantum\'s own existing definition used everywhere else in the app — Futwork Human QL + Futwork AI QL over Total Queued on Futwork, excluding Superbot and Floor-routed leads.',
