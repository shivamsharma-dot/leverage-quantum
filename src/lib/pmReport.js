...
export const REPORT_VERSIONS = [
  {
    ...
    what: [
      ...
      'Message 2 (Sales Efficiency) — Total QL this month with its SR/AC split (from Monthly QLs\' own pipeline; a non-zero unsplit Superbot QL is disclosed on its own line), total Applications this month (unfiltered), AC Sales, and a combined QL → Outcome % ((Applications + AC Sales) ÷ Total QL), plus the QL daily run-rate.',
