...
const DASHBOARDS = [
  {
    ...
    label: 'Meta Ads',
    description: 'Creative and campaign performance from the Meta Ads API: spend, ROAS, CTR and creative fatigue.',
    metrics: ['Creatives', 'Campaigns', 'Spend', 'ROAS'],
    source: 'Meta API · Live',
    lastUpdated: 'Live from Meta',
    color: 'blue',
    live: true,
  ...
  },
  {
    ...
    label: 'Google Ads',
    description: 'Search and Performance Max campaigns: spend, clicks, conversions, keywords and ad groups.',
    metrics: ['Campaigns', 'Keywords', 'Clicks', 'Conv.'],
    source: 'Google Ads API · Live',
    lastUpdated: 'Live from Google Ads',
    color: 'green',
    live: true,
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>
  },
  {
    id: 'roas',
    to: '/dashboard/roas',
  ...
  },
  {
    ...
    to: '/dashboard/lq-ops',
    label: 'QL Ops',
    description: 'Futwork and Superbot qualification performance: qualified leads by source, campaign and provider.',
    metrics: ['Futwork', 'Superbot', 'QL%', 'By source'],
    source: 'Google Sheets · Live',
    lastUpdated: 'Live from Sheet',
    color: 'green',
    live: true,
  ...
  },
  {
    ...
    label: 'WhatsApp',
    description: 'WhatsApp marketing spend: messages sent, delivered, read and clicked by campaign and phone number.',
    metrics: ['Sent', 'Delivered', 'Read', 'CTR'],
    source: 'Google Sheets · Live',
    lastUpdated: 'Live from Sheet',
    color: 'green',
    live: true,
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/></svg>
  },
]
