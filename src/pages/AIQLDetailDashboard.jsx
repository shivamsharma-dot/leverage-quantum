...
// No human handoff in this pipeline (fully bot-qualified) -- "Interested in Callback"
// is the highest-intent outcome, analogous to Human QL's "Call Transferred To Counsellor".
const HOT_DISPOSITION = 'Interested in Callback'
      ...
      <div style={{ margin: '12px 14px 0', borderRadius: 14, border: '1px solid #EEF1F6', boxShadow: '0 1px 3px rgba(31,60,132,0.06)', flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        <div style={{ background: 'var(--card)', borderBottom: '0.5px solid ' + C.border, padding: '0 28px', minHeight: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexShrink: 0, flexWrap: 'wrap' }}>
          <div style={{ padding: '10px 0' }}>
            <p style={{ fontSize: 10.5, color: C.muted, margin: 0, letterSpacing: '0.05em', textTransform: 'uppercase' }}>QL Ops / AI QL Detail</p>
          ...
          <Card title={'Lead detail — ' + fmtN(sorted.length) + ' records'} sub="Search by course, country, campaign or ID · drag column headers to reorder" noPad
            action={
              <div style={{ display: 'flex', gap: 8, alignItems: 'center', position: 'relative' }}>
                ...
                <ExportButton data={exportRows} filename="ai_ql_detail" />
                {colsOpen && (
                  <>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {pageItems.map((r, i) => {
                    ...
                    return (
                      <tr key={r.prospectId || i} style={{ background: isHot ? C.greenBg : 'transparent' }} title={isHot ? 'Interested in callback -- hot lead' : undefined}>
