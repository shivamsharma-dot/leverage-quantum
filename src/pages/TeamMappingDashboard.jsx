...
function RosterTab({ isAdmin, onOpenHistory, onOpenAddUser, registerRefresh }) {
  ...
  // TBL-3: nothing signalled the table scrolls sideways -- you had to scroll
  // past 50 rows first (thanks to TBL-1's own maxHeight wrapper) to even
  // discover 12 more columns exist. A right-edge shadow (and a left one once
  // actually scrolled) that tracks the wrapper's own scroll position, so the
