...
const CH_COLORS = { Facebook:'#1C9FD4', Google:'#10B981', LinkedIn:'#3B82F6', Bing:'#F59E0B' }
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            ...
            <button onClick={() => setShowCompare(true)}
              style={{display:'flex',alignItems:'center',gap:6,padding:'7px 13px',borderRadius:8,background:'#EEF2FF',border:'1px solid #C7D2FE',color:'#1F3C84',fontSize:12.5,fontWeight:600,cursor:'pointer',fontFamily:"'Plus Jakarta Sans','Inter',sans-serif"}}>
