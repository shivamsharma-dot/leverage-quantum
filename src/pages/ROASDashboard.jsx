          ...
          <div className={styles.chartBox}>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <AreaChart data={monthlyChart} margin={{top:8,right:8,left:0,bottom:0}}>
                ...
                <Area type="monotone" dataKey="spend" name="Spend" stroke="#6366F1" strokeWidth={2.5} fill="url(#spendGrad)" dot={false} activeDot={{r:5,fill:'#6366F1'}}/>
              </AreaChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className={styles.chartBox}>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={monthlyChart.filter(m=>m.total_rev>0||m.proj_rev>0)} margin={{top:8,right:8,left:0,bottom:0}} barCategoryGap="25%">
                ...
                <Bar dataKey="proj_rev"  name="Proj Rev"     fill="#6366F1" radius={[5,5,0,0]} fillOpacity={0.6}/>
              </BarChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className={styles.chartBox}>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <LineChart data={monthlyChart.filter(m=>m.roas>0||m.proj_roas>0)} margin={{top:8,right:16,left:0,bottom:0}}>
                ...
                <Line type="monotone" dataKey="proj_roas" name="Proj ROAS" stroke="#6366F1" strokeWidth={2} strokeDasharray="6 3" dot={{r:4,strokeWidth:2,fill:'#fff',stroke:'#6366F1'}} activeDot={{r:5}}/>
              </LineChart>
            </ResponsiveContainer>
          </div>
                  ...
                  return Object.values(map).sort((a,b)=>b.spend-a.spend).map(r=>{
                    ...
                    return(
                      <tr key={r.channel}>
                        ...
                        <td><span style={{fontWeight:700,color:'#6366F1'}}>{proas>0?proas+'x':'–'}</span></td>
                      </tr>
                    )
                  })
                })()}
