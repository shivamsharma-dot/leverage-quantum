...
import { SOURCE_COLORS } from '../ui/dashboardKit'

// Channel hues come from the shared map in dashboardKit so a source keeps the same
// colour on every page. See DESIGN_SYSTEM.md "Chart bars". The old local map used
// off-brand amber for Referral/Affiliate and gave Facebook, Offline and Branding the
// same blue, which made this chart's legend impossible to read.
          ...
          <div className={styles.card}>
            ...
            <ResponsiveContainer width="100%" height={240}>
              <BarChart data={monthlyOPPs} margin={{top:4,right:8,left:0,bottom:0}}>
                ...
                <YAxis tick={{fontSize:12,fill:'#9CA3AF'}} axisLine={false} tickLine={false} tickFormatter={v=>fmt(v)} width={55}/>
          ...
          <div className={styles.card}>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={monthlySpend} margin={{top:4,right:8,left:0,bottom:0}}>
                <CartesianGrid strokeDasharray="3 3" stroke="#F1F5F9" vertical={false}/>
                <XAxis dataKey="month" tick={{fontSize:12,fill:'#9CA3AF'}} axisLine={false} tickLine={false}/>
                <YAxis tick={{fontSize:12,fill:'#9CA3AF'}} axisLine={false} tickLine={false} tickFormatter={v=>fmtR(v)} width={65}/>
                <Tooltip content={<BrandTooltip/>}/>
                <Legend wrapperStyle={{fontSize:12}}/>
