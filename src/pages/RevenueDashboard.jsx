...
const SRC_COLORS = {
  ...
  Offline:'#8B5CF6', Bing:'#84CC16', Branding:'#3B82F6', Unidentified:'#D1D5DB'
}
      ...
      <main className={styles.main}>
        ...
        <div className={styles.kpiRow}>
          {[
            ...
            {l:'VAS Revenue',    v:fmtR(totals.total_vas),  s:'Value Added Services',         c:'#6366F1'},
            {l:'Total Revenue',  v:fmtR(totals.total_rev),  s:'AC + VAS Collected',           c:'#F59E0B'},
            {l:'Projected',      v:fmtR(totals.total_proj), s:'Total Package Value',          c:'#3B82F6'},
          ...
          <div className={styles.card}>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={acVasMonthly} margin={{top:4,right:8,left:0,bottom:0}} barCategoryGap="25%">
                ...
                <Bar dataKey="VAS" name="VAS Revenue" fill="#6366F1" radius={[4,4,0,0]}/>
              </BarChart>
            </ResponsiveContainer>
          </div>
