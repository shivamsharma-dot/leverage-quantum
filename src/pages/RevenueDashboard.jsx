...
const KPICard = ({ label, value, sub, accent=C_KPI.navy, accentBg=C_KPI.navyBg, delta, icon }) => (
  <div style={{ background:'#fff', border:`0.5px solid ${C_KPI.border}`, borderRadius:14, padding:'18px 20px', borderTop:`3px solid ${accent}`, boxShadow:'0 1px 6px rgba(15,23,42,0.06)', display:'flex', flexDirection:'column', gap:8, fontFamily:FONT_KPI, transition:'transform .2s,box-shadow .2s' }}
    ...
    <div className={styles.layout}>
      ...
      <div className={styles.main}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(6,1fr)', gap:12, marginBottom:20 }}>
          ...
          <KPICard label="Collection %"  value={totals.collection_pct+'%'} sub="Collected / Projected" accent={parseFloat(totals.collection_pct)>=50?C_KPI.green:C_KPI.amber} accentBg={parseFloat(totals.collection_pct)>=50?C_KPI.greenBg:C_KPI.amberBg}
