...
import { BarGrad, barFill, BAR_RADIUS, BAR_RADIUS_H, BAR_MAX, NEUTRAL_TRACK, sourceColor } from '../ui/dashboardKit'
...
// Channel hues come from the shared map; anything not named there gets a stable
// on-brand tone from sourceColor(). The old local map used amber, red and a sky
// blue, and disagreed with every other page on Google, Bing and WhatsApp.
      ...
      <div className={styles.main}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:12, marginBottom:20 }}>
          {kpis.slice(0,4).map(k => {
            const accentMap = { kbl:C_KPI.navy, kam:C_KPI.cyan, kgn:C_KPI.green, krd:C_KPI.navy }
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:12, marginBottom:20 }}>
          {kpis.slice(4).map(k => {
            const accentMap = { kbl:C_KPI.blue, kam:C_KPI.cyan, kgn:C_KPI.green, krd:C_KPI.navy }
          ...
          <div className={styles.chartCard}>
            ...
            <div className={styles.funnel}>
              {[
                ...
                {l:'QLs',          v:totals.qls,     c:'#4CAE6F', sub: pct(totals.qls,totals.futwork)+' of Futwork'},
          ...
          <div className={styles.chartCard}>
            ...
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={monthlyTrend}>
                ...
                <Line type="monotone" dataKey="qlPct" name="QL%" stroke="#29B9C3" strokeWidth={2.5} dot={{r:4,fill:'#29B9C3'}} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
                ...
                <tbody>
                  {channelBreakdown.map(r => {
                    ...
                    return (
                      <tr key={r.channel}>
                        <td>
                          <span className={styles.chBadge} style={{color:sourceColor(r.channel)||'#6B7280',background:(sourceColor(r.channel)||'#9CA3AF')+'18'}}>
                            {r.channel}
                          </span>
                        </td>
