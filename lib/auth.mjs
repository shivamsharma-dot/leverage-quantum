...
// nishant.bhatia, and this page is Shivam's own BigQuery beta. email is optional
// (existing callers that only pass role/dashboardId are unaffected for every
// other id) and is only ever consulted for this one dashboardId.
